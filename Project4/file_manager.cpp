...
// The program is designed to meet several requirements, including the ability to create and rename directories, 
// enabling the program to run the commands simultaneously when multiple commands are given using the prompt, 
// running a user accessing directories, and renaming.
// ---------------------------------------------------------------------------------------------------------------------------- */
